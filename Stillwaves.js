...
(function() {
  ...
  let playlist = [
      ...
      { id: "amOSaNX7KJg", title: "숀 (SHAUN) - 웨이백홈 (Way Back Home) [Lyric Video]", moods: ["calm", "relax", "slow-day"], language: "korean", backgroundType: "lyrics-video"},
      ...
      {id: "Q1brFg4E-3c", title: "Tate McRae - r u ok", moods:["slow-day", "sad"], language: "english"},
      {id: "hsaRX6lvEAI", title: "Tate McRae - feel like shit (Lyrics)", moods:["slow-day", "sad"], language: "english"},
      {id: "IGCUmv0dtNE", title: "Tate McRae - happy face (Lyrics)", moods:["slow-day", "sad"], language: "english", backgroundType: "lyrics-video"},
